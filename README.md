...
- `src/content/chapters/` — chapter MDX files (FR→EN translation)
- `src/pages/` — Astro pages (index, chapter reader, interactive tools)
- `src/components/` — React and Astro components (natal chart, gematria player, etc.)
- `public/` — static assets (images, WASM, ephemeris files)
